...
use ripaym1970\autocrud\components\widgets\MultipleInput\renderers\RendererInterface;
use ripaym1970\autocrud\components\widgets\MultipleInput\renderers\TableRenderer;
use Yii;
...
{
    const POS_HEADER_BEGIN = RendererInterface::POS_HEADER_BEGIN;
    ...
    protected function createRenderer()
    {
        ...
        $config = [
            ...
            'data'              => $this->models,
            'columnClass'       => $this->columnClass !== null ? $this->columnClass : TabularColumn::class,
