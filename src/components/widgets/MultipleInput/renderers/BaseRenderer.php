...
namespace ripaym1970\autocrud\components\widgets\MultipleInput\renderers;

use ripaym1970\autocrud\components\widgets\MultipleInput\assets\MultipleInputAsset;
use ripaym1970\autocrud\components\widgets\MultipleInput\assets\MultipleInputSortableAsset;
use ripaym1970\autocrud\components\widgets\MultipleInput\components\BaseColumn;
use ripaym1970\autocrud\components\widgets\MultipleInput\MultipleInput;
...
abstract class BaseRenderer extends BaseObject implements RendererInterface
{
    ...
    protected function getExtraButtons($index, $item)
    {
        ...
        if (!is_string($content)) {
            throw new InvalidArgumentException('Property "extraButtons" must return string.');
        }
